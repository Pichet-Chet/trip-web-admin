...
> **ให้เพื่อน 1 บริษัทใช้จนติด → ขอ referral → ให้ product ขายตัวเองผ่าน "Powered by [Platform]" + Posts ดึง traffic เข้าแพลตฟอร์ม**

### 1.2 หลักการ GTM ของ [Platform]

| หลักการ | เหตุผล |
|---|---|
| **Product-Led Growth (PLG)** | ทุก trip link = marketing ฟรี (Powered by [Platform]) |
...
| **ลูกทริป = ช่องทางขาย** | ลูกทริปเห็น [Platform] → แนะนำ บ.ทัวร์ของตัวเอง |
| **Posts = ช่องทาง Acquisition ใหม่** | Posts บน Info Website ดึง traffic จาก Google → บริษัทแข่งกันโปรโมตบน [Platform] แทนสร้างเว็บเอง |

### 1.3 Target Customer Profile

```
┌─────────────────────────────────────────────────────────────┐
│  Ideal Customer Profile (ICP) — 3 Account Types             │
├─────────────────────────────────────────────────────────────┤
│                                                             │
│  1. Company (บริษัททัวร์)                                     │
...
│                                                             │
│  2. Freelance Guide (ไกด์อิสระ)                              │
│     ใคร:  ไกด์ที่ไม่มีบริษัท ทำเองคนเดียว                     │
│     ปัญหา: ไม่มีเว็บไซต์ ไม่มีงบทำเว็บ ต้องการแพลตฟอร์ม      │
│            โปรโมตทัวร์แพ็คเกจ                                 │
│     ใช้อะไรอยู่: Facebook Page / LINE @ เท่านั้น               │
│     คนตัดสินใจ: ตัวเอง                                       │
│                                                             │
│  3. Personal (บุคคลทั่วไป)                                    │
│     ใคร:  คนที่วางแผนทริปเที่ยวกับเพื่อน/ครอบครัว             │
│     ปัญหา: วางแผนทริปใน LINE แชท → ข้อมูลหาย               │
│     ใช้อะไรอยู่: Google Docs / LINE Notes                    │
│     ใช้ [Platform] เพื่อ: Trip Builder สร้างแพลนทริปแชร์เพื่อน     │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
...
| **The Tech-Savvy Guide** | เจ ไกด์ | อยากให้ลูกทริปเตรียมตัวมาดี เปิดดูข้อมูลก่อนไป | เห็น [Platform] จากทริปที่ตัวเองไป → อยากใช้บ้าง |
| **The Growing Agency** | คุณสมชาย MD | บริษัทโตเร็ว อยากมีระบบ professional | เสียลูกค้าเพราะส่ง itinerary ผิดเวอร์ชัน |
| **The Freelance Guide** | พี่ต้น ไกด์อิสระ | ไม่มีเว็บไซต์ ไม่มีงบ อยากโปรโมตทัวร์ออนไลน์ | เห็น Posts ของคนอื่นบน [Platform] → อยากมีบ้าง |
| **The Personal Planner** | มิ้น | วางแผนทริปกับเพื่อน 10 คน ข้อมูลจมใน LINE | เพื่อนแชร์ trip link → เห็นว่าสะดวกมาก → สมัครใช้เอง |

---

## 2. Pricing Strategy

### 2.1 Pricing Model — Pay-per-Trip

```
┌──────────────────────────────────────────────────────────────┐
│                                                              │
│   Free              Pay-per-Trip       Pack 5      Pack 10   │
│   0 บาท             ฿49/ทริป            ฿199        ฿349     │
│                                        (฿39.8/ทริป) (฿34.9/ทริป)│
│   ✓ 3 ทริป           ✓ ซื้อทีละทริป      ประหยัด 19%  ประหยัด 29%│
│   ✓ "Powered by"     ✓ Full features                        │
│     [Platform] badge     ✓ No badge                             │
│   ✓ Basic features     (optional)                            │
│                                                              │
│   หมายเหตุ:                                                    │
│   - Subscription option อยู่ระหว่างพิจารณาเพิ่มเติม             │
│   - ราคาสุดท้ายจะ confirm กับทีม marketing อีกครั้ง              │
│                                                              │
└──────────────────────────────────────────────────────────────┘
```
...
| ตัดสินใจ | เหตุผล |
|---|---|
| **Free tier มี 3 ทริป** | พอให้บริษัทเล็ก/ไกด์อิสระใช้จริง → ติด → อยากซื้อเพิ่ม |
| **Free tier มี "Powered by"** | ทุก trip link ของ free user = โฆษณา [Platform] ฟรี |
| **Pay-per-Trip ฿49** | จ่ายเท่าที่ใช้ ไม่ต้องผูกมัดรายเดือน — เหมาะกับไกด์อิสระ/บริษัทเล็ก |
| **Pack pricing ลดต่อทริป** | incentive ซื้อ Pack → ลดราคาต่อทริป + ได้เงินล่วงหน้า |
| **ไม่มี subscription (ตอนนี้)** | ลูกค้าไทยคุ้นกับจ่ายตามใช้ > ค่ารายเดือน, subscription อยู่ระหว่างพิจารณา |
| **LINE noti อยู่ใน paid** | Free tier ใช้ Web Push ได้อยู่ — LINE เป็น incentive ซื้อ |

### 2.3 Free → Paid Conversion Triggers

```
Free user สร้างทริปที่ 4        → "ซื้อทริปเพิ่ม ฿49/ทริป หรือ Pack 5 ประหยัด 19%"
Free user อยากส่ง LINE noti     → "LINE notification เป็นฟีเจอร์ Paid"
Free user อยากซ่อน [Platform] badge → "ซ่อน badge ด้วยทริปแบบ Paid"
Free user ดู read receipt       → "ดู dashboard ใครเห็นแล้ว ด้วยทริปแบบ Paid"
ไกด์อิสระเห็น Posts ของคนอื่น    → "สร้าง Posts โปรโมตทัวร์ ดึงลูกค้าเข้ามา"
```
...
| 8 | สร้าง LINE OA | LINE OA verified |
| 9 | สร้าง Landing Page ([your-domain.com]) | Waitlist form |
...
- "Powered by [Platform]" badge preview
...
├── ถามเพื่อน: "ถ้าเก็บเงิน ฿49/ทริป จ่ายไหม?"
...
| **Willingness to pay** | "จ่าย ฿49/ทริป ได้เลย" | ถามตรง |
...
| เพื่อนบอก "ฟรีก็ใช้ แต่จ่ายไม่จ่าย" | ไม่มี Paid value | เพิ่ม Paid features ที่มีคุณค่าจริง |
...
|---|---|---|---|
| **Referral (หลัก)** | ลูกค้าเดิมแนะนำ → ทั้งคู่ได้ทริปฟรี 1 ทริป | ~1,000 บ/เดือน | 10-15 accounts |
| **Posts / Info Website** | บริษัท/ไกด์โพสต์ทัวร์แพ็คเกจ → Google ดึง traffic เข้า | ฟรี | 5-10 accounts |
...
│                                              │
│  ผู้แนะนำ (Referrer):                         │
│  ✓ ได้ทริปฟรี 1 ทริป ต่อทุก referral           │
│  ✓ สะสมได้ไม่จำกัด                            │
│                                              │
│  ผู้ถูกแนะนำ (Referee):                        │
│  ✓ ได้ทริปฟรี 1 ทริป (เพิ่มจาก 3 ทริป free)    │
│                                              │
│  วิธีแนะนำ:                                    │
...
#### 3.2.3 Posts / Info Website Strategy (ช่องทาง Acquisition ใหม่)

**แนวคิด:** Posts เป็นระบบโพสต์ทัวร์แพ็คเกจ แสดงบน Info Website (พัฒนาโดย Nes) เพื่อดึง traffic จาก Google

**Posts กับ Trips เป็นอิสระจากกัน:**
- **Posts** = ดึงคนเข้ามาในแพลตฟอร์ม (Acquisition)
- **Trips** = ให้บริการลูกค้าที่เข้ามาแล้ว (Service)

| กลุ่มเป้าหมาย | ทำไมต้อง Posts บน [Platform]? |
|---|---|
| **บริษัททัวร์** | แข่งโปรโมตทัวร์บนแพลตฟอร์ม [Platform] แทนสร้างเว็บเอง |
| **ไกด์อิสระ** | ไม่มีงบทำเว็บ → ใช้ Posts เป็นหน้าร้านออนไลน์ showcase ทัวร์ |
| **ผู้ค้นหาทัวร์ (B2C)** | ค้นหาทัวร์ใน Google → เจอ Info Website → ดู Posts → ติดต่อบริษัท |

**Flow:**
```
User ค้นหา "ทัวร์ญี่ปุ่น ซากุระ 2569" ใน Google
     │
     ▼
เจอ Info Website ([Platform]) ใน search results
     │
     ▼
ดู Posts ทัวร์แพ็คเกจจากหลายบริษัท
     │
     ▼
เลือกแพ็คเกจ → ติดต่อบริษัท
     │
     ▼
บริษัทใช้ Trip Builder สร้างทริป → ส่ง link ให้ลูกค้า
```

#### 3.2.4 Facebook Groups Strategy
...
| ไกด์อิสระ | 3,000+ | Tutorial video "สร้าง itinerary 5 นาที" + "โพสต์ทัวร์ฟรี" |
...
| 3 | "ลูกทริปแชร์: ชอบดูบนมือถือมากกว่า PDF" | Before/After: LINE Group vs [Platform] |
...
| **Consideration** | Lead gen | Retarget: คนที่เข้า [your-domain.com] | Carousel: 3 pain points + solution |
...
- Cost per paying customer: ~1,500-3,000 บ (จาก free → paid conversion ~10%)
...
| **Posts / Info Website** | ฟรี | 10-15 signups | 0 บ |
...
| **รวม** | **~15,000** | **45-80 signups** | **~280 บ** |
...
| ทัวร์ญี่ปุ่น / ทัวร์ยุโรป (+ variants) | 5,000+/เดือน | สูง | Posts บน Info Website |

**Content Strategy:**
- 2 blog posts / เดือน (SEO-focused)
- 1 case study / เดือน (จากลูกค้าจริง)
- 1 tutorial video / เดือน (YouTube + Facebook)
- Posts บน Info Website เป็น long-tail SEO เพิ่มเติม (จากบริษัท/ไกด์ที่สร้างเอง)

#### 3.3.3 Partnership Strategy

| Partner | เข้าถึงอย่างไร | Win-Win |
|---|---|---|
| **สมาคมมัคคุเทศก์อาชีพ** | ติดต่อสมาคม → เสนอ co-host webinar | [Platform] ได้ credibility + reach, สมาคมได้ content |
| **Travel blogger / influencer** | ให้ทริปฟรี → review | [Platform] ได้ awareness, blogger ได้ content |
| **ที่ปรึกษาธุรกิจท่องเที่ยว** | ให้ referral commission | [Platform] ได้ leads, ที่ปรึกษาได้ passive income |
| **TAT (ททท.)** | เสนอเป็น Thai startup showcase | [Platform] ได้ credibility + PR |
...
```
═══════════════════════════════════════════════════
  Loop A: B2B Viral (Powered by Badge)
═══════════════════════════════════════════════════
...
ลูกทริป 30 คน เปิดดู (30 views)
     ...
     │     │
     │     ▼
     │   40+ คนเห็น [Platform] (40 impressions)
     │     │
     │     ├── 2-3 คนเป็นเจ้าของ บ.ทัวร์ / ไกด์
     │     │     │
     │     │     ▼
     │     │   "Powered by [Platform]" → คลิก → Landing page
     │     │     │
     │     │     ▼
     ...
     │           │
     │           ▼
     │         "ลองใช้ [Platform] สิ ทริปที่เพิ่งไป เขาใช้แล้วดีมาก"
     │
     └── Immigration View → Officer เห็น → ไม่ใช่ viral แต่สร้าง credibility


═══════════════════════════════════════════════════
  Loop B: Posts Discovery (Info Website)
═══════════════════════════════════════════════════

User ค้นหาทัวร์ใน Google
     │
     ▼
เจอ Info Website ([Platform]) → ดู Posts ทัวร์แพ็คเกจ
     │
     ├── ติดต่อบริษัท → บริษัทใช้ Trip Builder
     │
     └── บริษัทอื่นเห็นว่ามีคนค้นหาเจอ → สมัครมาโพสต์ด้วย
           │
           ▼
         Posts เพิ่ม → SEO ดีขึ้น → traffic เพิ่ม → วนลูปซ้ำ


═══════════════════════════════════════════════════
  Loop C: B2C Viral (Personal → B2B)
═══════════════════════════════════════════════════

เพื่อนสร้างทริปส่วนตัว → แชร์ link ให้เพื่อน 10 คน
     │
     ▼
10 คนเห็น "Powered by [Platform]" + ใช้งาน
     │
     ├── บางคนทำงานในวงการท่องเที่ยว
     │     │
     │     ▼
     │   "อ๋อ ใช้จัดทริปบริษัทก็ได้นี่" → สมัครใช้ B2B
     │
     └── บางคนเอาไปใช้วางแผนทริปกับเพื่อนอีกกลุ่ม → วนลูปซ้ำ
```
...
| Metric | สูตร | Target |
|---|---|---|
| **Viral Coefficient (K)** | (avg guests/trip) x (share rate) x (conversion rate) | K > 0.3 |
...
| **Posts to Contact** | จำนวนคนติดต่อบริษัท / จำนวนคนดู Posts | > 3% |
| **Posts to B2B Signup** | B2B signups จาก Posts / total Posts views | > 1% |
...
| **Posts SEO optimization** | ใส่ keyword + structured data ใน Posts | Traffic ↑ |
...
(เจอ [Platform])                 (ลองดู)                      (สมัคร)
     ...
     ├── Google search            ├── ดู Case study           ├── ติด → ซื้อทริปเพิ่ม
     ├── Facebook ads             ├── ดู Video tutorial       ├── ฿49/ทริป หรือ Pack
     ├── Posts บน Info Website    └── ดู Posts ทัวร์แพ็คเกจ        │
     └── เพื่อนแชร์ trip link                                Expansion
                                                              (โตต่อ)
                                                                   │
                                                              ├── แนะนำเพื่อน
                                                              ├── ใช้ทุกทริป
...
|---|---|---|
| 1. Lead | ได้ contact จาก referral / inbound / Posts | LINE / Email |
...
| 6. Close | เสนอ Pack 10 (฿349 = ฿34.9/ทริป) | Payment link |
...
| "PDF สวยกว่า" | "[Platform] สวยเหมือนกันครับ แถม update ได้แบบ live ไม่ต้องส่งไฟล์ใหม่ทุกครั้ง" |
| "ลูกค้าไม่น่าจะดู" | "เราทดสอบแล้ว 80%+ เปิดดูครับ เพราะเข้าง่ายมาก ไม่ต้อง login ไม่ต้องลง app" |
| "แพง" | "Free tier ใช้ได้ 3 ทริปเลยไม่เสียตังค์ครับ ลองก่อน ถ้าชอบค่อยซื้อเพิ่ม แค่ ฿49/ทริป" |
...
| "ทำไมต้องมาโพสที่ [Platform]?" | "Info Website ของ [Platform] ติด Google ครับ คนค้นหาทัวร์เจอโพสต์ของคุณเลย ไม่ต้องทำ SEO เอง ไม่ต้องจ่ายค่าโฆษณา" |
| "เว็บขายทัวร์ของตัวเองก็มีอยู่แล้ว" | "ดีเลยครับ แต่ [Platform] เป็นอีกช่องทางหนึ่ง เหมือนลงขายใน marketplace เพิ่ม ได้ traffic จาก Google ฟรี ไม่ขัดกับเว็บเดิมครับ" |
...
| **Posts / Tour Listings** | SEO + Acquisition | "ทัวร์แพ็คเกจจากบริษัทจริง ค้นหาได้บน Info Website" |
...
| 6 | Tutorial: "โพสต์ทัวร์แพ็คเกจบน [Platform]" | FB: Feature highlight | YouTube: Feature deep-dive |
...
| **Revenue** | Free → Paid conversion | > 10% | Trip purchases |
...
│  Posts views:        620 (+25%)         │
│                                         │
│  Revenue (Pay-per-Trip)                 │
│  Paid trips sold:    18                 │
│  Revenue this week: 762 บ              │
│  Pack purchases:      2 (Pack 5 + 10)  │
│  Monthly revenue:  ~3,048 บ            │
│                                         │
│  Viral                                  │
│  Powered by clicks:  62                 │
│  Badge → Signup:      3 (4.8%)          │
│  Posts → Contact:     8 (1.3%)          │
│  Viral coefficient:   0.32              │
│                                         │
└─────────────────────────────────────────┘
```
...
│                   ├── Get referrals     ├── Posts launch      ├── Scale ads + Posts
│                   │                    ├── Content start     │
│                   │                    │                    │
...
| **Free users ไม่ซื้อทริปเพิ่ม** | สูง | ปรับ Paid value proposition + ลดราคาช่วง early + พิจารณา subscription |
| **Facebook Groups ไม่ให้โพสต์** | กลาง | เน้น value content > promo + สร้างกลุ่มเอง |
| **Ads ไม่ work (CAC สูง)** | กลาง | Shift budget ไป content + referral + Posts |
| **ไม่มีใครคลิก Powered by** | ต่ำ-กลาง | A/B test badge design + placement |
| **คนไทยไม่อยากจ่ายค่า per-trip** | สูง | เน้น ROI: "฿49 vs เสียลูกค้า 1 คน" + เพิ่ม free tier value + พิจารณา subscription |
| **Posts ไม่มีคนมาโพสต์** | กลาง | Seed content เอง + ช่วยไกด์สร้าง Posts แรก + incentive ทริปฟรี |
| **Info Website ไม่ติด Google** | กลาง | ลงทุน SEO + structured data + content quality |

---

## 10. สรุป

### GTM ของ [Platform] = 4 เครื่องยนต์

```
┌─────────────────────────────────────────────────────────────────┐
│                                                                 │
│   Engine 1: Viral Loop (ฟรี)                                    │
│   ├── ทุก trip link มี "Powered by [Platform]"                      │
│   ├── ลูกทริป 30 คน/ทริป x 10 ทริป/เดือน = 300 คนเห็น          │
│   └── 2-3% convert = 6-9 signups/เดือน ฟรี                     │
│                                                                 │
│   Engine 2: Posts / Info Website (ฟรี)                          │
│   ├── บริษัท/ไกด์โพสต์ทัวร์แพ็คเกจ → Google ดึง traffic         │
│   ├── ผู้ค้นหาทัวร์เจอ → ติดต่อบริษัท → บริษัทใช้ Trip Builder   │
│   └── ยิ่งมี Posts มาก → SEO ยิ่งดี → traffic ยิ่งเยอะ           │
│                                                                 │
│   Engine 3: Referral (ต้นทุนต่ำ)                                │
│   ├── ลูกค้าแนะนำเพื่อนในวงการ                                  │
│   ├── ทั้งคู่ได้ทริปฟรี 1 ทริป                                   │
│   └── CAC = ~49 บ/account (ค่าทริปที่ให้ฟรี)                    │
│                                                                 │
│   Engine 4: Content + Ads (ลงทุน)                               │
│   ├── Blog + SEO สำหรับ long-term organic                       │
│   ├── Facebook Ads สำหรับ short-term boost                      │
│   └── CAC = ~600 บ/account                                     │
│                                                                 │
│   รวม 4 engines = 45-80 signups/เดือน @ Phase 3                │
...
3. **Posts ต้องมี content ดี** — Info Website ต้องติด Google เพื่อดึง traffic
4. **฿49/ทริป ต้อง feel cheap** — ลูกค้าต้องรู้สึกว่า "แค่นี้เอง"
5. **Content ต้อง authentic** — ใช้เรื่องจริง คนจริง ไม่ใช่ marketing speak

---

*Document End — [Platform] Go-to-Market Strategy v2.0*
