      ...
      <section className="flex-1 flex items-center justify-center p-6 sm:p-12 lg:p-20 bg-(--surface) overflow-y-auto">
        <div className="w-full max-w-lg">
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <button className="w-full flex items-center justify-center gap-3 bg-[#06C755] hover:brightness-105 transition-all text-white py-4 px-6 rounded-full font-semibold shadow-md active:scale-[0.98] duration-200">
              <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M24 10.304c0-4.579-5.383-8.304-12-8.304s-12 3.725-12 8.304c0 4.105 4.27 7.545 10.046 8.204.391.084.924.258 1.058.592.121.303.079.777.038 1.082l-.166 1.012c-.05.303-.242 1.188 1.038.647 1.28-.54 6.892-4.06 9.407-6.948 1.74-2.002 2.579-3.488 2.579-4.589z"/></svg>
              สมัครด้วย LINE
            </button>
          </div>
