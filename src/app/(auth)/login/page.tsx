      ...
      <section className="flex-1 flex items-center justify-center p-6 sm:p-12 lg:p-20 bg-(--surface)">
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-1 gap-4 mb-8">
            <button className="w-full flex items-center justify-center gap-3 bg-[#06C755] hover:opacity-90 transition-all text-white py-3.5 px-6 rounded-xl font-semibold shadow-sm active:scale-[0.98] duration-200">
