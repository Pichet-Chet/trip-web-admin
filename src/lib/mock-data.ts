...
// ─── Posts (Tour Package Listings) ───
export const mockPosts: Post[] = [
  {
    id: "post-001",
    companyId: "comp-001",
    slug: "japan-autumn-tokyo-fuji-kyoto",
    title: "ทริปญี่ปุ่นใบไม้เปลี่ยนสี โตเกียว — ฟูจิ — เกียวโต",
    destination: "ญี่ปุ่น",
    description: "เที่ยวครบ 3 เมืองหลัก ชมใบไม้เปลี่ยนสีที่สวยที่สุดในรอบปี พร้อมไกด์ภาษาไทยดูแลตลอดทริป รวมตั๋วเครื่องบิน ที่พัก 4 ดาว และอาหาร",
    highlights: ["ชมใบไม้เปลี่ยนสีที่เกียวโต", "ถ่ายรูปฟูจิวิวทะเลสาบ", "ช้อปปิ้ง Shibuya + Shinjuku", "ออนเซ็น Hakone"],
    images: ["https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=600", "https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?w=600"],
    priceStartFrom: 45900,
    duration: "8 วัน 7 คืน",
    travelPeriod: "ต.ค. — พ.ย. 2569",
    totalSlots: 25,
    slotsLeft: 8,
    status: "published",
  ...
  },
  {
    id: "post-002",
    companyId: "comp-001",
    slug: "korea-seoul-nami-everland",
    title: "เกาหลีใต้ โซล — เกาะนามิ — เอเวอร์แลนด์",
    destination: "เกาหลีใต้",
    description: "เที่ยวโซลครบทุกไฮไลท์ พระราชวัง ย่านฮงแด เกาะนามิ สวนสนุกเอเวอร์แลนด์ พร้อมช้อปปิ้งเมียงดง",
    highlights: ["พระราชวัง Gyeongbokgung", "เกาะนามิ", "สวนสนุก Everland", "ช้อปปิ้ง Myeongdong"],
    images: ["https://images.unsplash.com/photo-1534274988757-a28bf1a57c17?w=600", "https://images.unsplash.com/photo-1517154421773-0529f29ea451?w=600"],
    priceStartFrom: 32900,
    duration: "5 วัน 4 คืน",
    travelPeriod: "พ.ค. — มิ.ย. 2569",
    totalSlots: 20,
    slotsLeft: 12,
    status: "published",
    tags: ["เกาหลี", "โซล", "เกาะนามิ"],
    viewCount: 856,
    inquiryCount: 3,
  ...
  },
  {
    id: "post-003",
    companyId: "comp-001",
    slug: "vietnam-danang-hoian-banahill",
    title: "เวียดนาม ดานัง — ฮอยอัน — บานาฮิลล์",
    destination: "เวียดนาม",
    description: "เที่ยวเวียดนามกลาง ดานัง ฮอยอัน บานาฮิลล์ สะพานมือทอง ราคาสบายกระเป๋า อาหารอร่อย วิวสวย",
    highlights: ["สะพานมือทอง บานาฮิลล์", "เมืองเก่าฮอยอัน (UNESCO)", "หาดมีเค ดานัง", "อาหารเวียดนาม street food"],
    images: ["https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=600"],
    priceStartFrom: 15900,
    duration: "4 วัน 3 คืน",
    travelPeriod: "เม.ย. — พ.ค. 2569",
    totalSlots: 30,
    slotsLeft: 0,
    status: "closed",
    tags: ["เวียดนาม", "ดานัง", "ฮอยอัน"],
    viewCount: 2100,
    inquiryCount: 15,
  ...
  },
  {
    id: "post-004",
    companyId: "comp-001",
    slug: "chiangmai-doi-inthanon-maekampong",
    title: "เชียงใหม่ ดอยอินทนนท์ — แม่กำปอง — คาเฟ่",
    destination: "เชียงใหม่",
    description: "ทริปเชียงใหม่ธรรมชาติ + คาเฟ่ เที่ยวดอยอินทนนท์ หมู่บ้านแม่กำปอง คาเฟ่วิวดอย พักรีสอร์ท 4 ดาว",
    highlights: ["ยอดดอยอินทนนท์ จุดสูงสุดของไทย", "หมู่บ้านแม่กำปอง", "คาเฟ่วิวดอย 3 ร้าน", "ตลาดวโรรส"],
    images: ["https://images.unsplash.com/photo-1598935898639-81586f7d2129?w=600"],
    priceStartFrom: 4720,
    duration: "3 วัน 2 คืน",
    travelPeriod: "เม.ย. 2569",
    totalSlots: 15,
    slotsLeft: 5,
    status: "draft",
    tags: ["เชียงใหม่", "ดอยอินทนนท์"],
    viewCount: 0,
    inquiryCount: 0,
